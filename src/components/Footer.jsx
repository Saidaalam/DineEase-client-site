...
const Footer = () => {
  ...
  <div className='flex gap-2 mb-2 mt-2'>
    ...
    <p className='text-start'>We are committed to providing the <br/> most delicious food items. We <br/> have exceptional results which are <br/> confirmed by the number of clients <br/> we serve.</p>
  </nav> 
  <nav> 
